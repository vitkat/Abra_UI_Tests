Проект "ABRA" организован с помощью Page Object. В данном проекте созданы автотесты для тестирования сайта "ABRA". Проект имеет каталог "Pages": - В данном каталоге лежат следующие страницы:
